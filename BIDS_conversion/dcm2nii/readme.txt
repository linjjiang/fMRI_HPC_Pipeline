...
# If you want to test a single subject-session, call the worker directly.
# It takes five positional arguments, in this order:
./dcm2niix_func.sh <subject_id> <session_date> <session_num> <input_dir> <output_dir>

# e.g.
./dcm2niix_func.sh 1001 20240115 01 "$DICOM_DIR" "$NIFTI_DIR"
