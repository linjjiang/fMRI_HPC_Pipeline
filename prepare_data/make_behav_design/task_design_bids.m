...
% Dummy-scan time was already removed at the very beginning by task_design.m,
% matching what fMRIPrep is told to discard in stage 3.
...
input_dir = cfg.BEHAV_DIR;
output_dir = input_dir;
TR = cfg.TR_num;       % seconds
